import { createHtmlDocsTemplate } from '@teambit/html.docs.docs-template';
 ...
 * @see https://bit.dev/docs/svelte-env/component-docs
 */
// export default createHtmlDocsTemplate([DocsProvider, BoldProvider]); // uncomment to use the providers above
export default createHtmlDocsTemplate([]);
